...
#ifndef FLATBUFFERS_GENERATED_FEEDREQUESTREJECT_COM_REACTIVEMARKETS_PAPI_H_
#define FLATBUFFERS_GENERATED_FEEDREQUESTREJECT_COM_REACTIVEMARKETS_PAPI_H_
...
inline flatbuffers::Offset<FeedRequestReject> CreateFeedRequestRejectDirect(
  ...
  return com::reactivemarkets::papi::CreateFeedRequestReject(
      _fbb,
      req_id__,
      error_code,
      error_message__);
...
#endif  // FLATBUFFERS_GENERATED_FEEDREQUESTREJECT_COM_REACTIVEMARKETS_PAPI_H_
