...
#ifndef FLATBUFFERS_GENERATED_MDSNAPSHOTL2_REACTIVE_PAPI_H_
#define FLATBUFFERS_GENERATED_MDSNAPSHOTL2_REACTIVE_PAPI_H_
...
struct MDSnapshotL2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const reactive::papi::MDLevel2 *> *bid_side() const {
    return GetPointer<const flatbuffers::Vector<const reactive::papi::MDLevel2 *> *>(VT_BID_SIDE);
  }
  const flatbuffers::Vector<const reactive::papi::MDLevel2 *> *offer_side() const {
    return GetPointer<const flatbuffers::Vector<const reactive::papi::MDLevel2 *> *>(VT_OFFER_SIDE);
  }
...
struct MDSnapshotL2Builder {
  ...
  void add_bid_side(flatbuffers::Offset<flatbuffers::Vector<const reactive::papi::MDLevel2 *>> bid_side) {
    fbb_.AddOffset(MDSnapshotL2::VT_BID_SIDE, bid_side);
  }
  void add_offer_side(flatbuffers::Offset<flatbuffers::Vector<const reactive::papi::MDLevel2 *>> offer_side) {
...
inline flatbuffers::Offset<MDSnapshotL2> CreateMDSnapshotL2(
    ...
    int16_t depth = 0,
    uint16_t flags = 0,
    flatbuffers::Offset<flatbuffers::Vector<const reactive::papi::MDLevel2 *>> bid_side = 0,
    flatbuffers::Offset<flatbuffers::Vector<const reactive::papi::MDLevel2 *>> offer_side = 0) {
...
inline flatbuffers::Offset<MDSnapshotL2> CreateMDSnapshotL2Direct(
    ...
    int16_t depth = 0,
    uint16_t flags = 0,
    const std::vector<reactive::papi::MDLevel2> *bid_side = nullptr,
    const std::vector<reactive::papi::MDLevel2> *offer_side = nullptr) {
  auto source__ = source ? _fbb.CreateString(source) : 0;
  auto market__ = market ? _fbb.CreateString(market) : 0;
  auto bid_side__ = bid_side ? _fbb.CreateVectorOfStructs<reactive::papi::MDLevel2>(*bid_side) : 0;
  auto offer_side__ = offer_side ? _fbb.CreateVectorOfStructs<reactive::papi::MDLevel2>(*offer_side) : 0;
  return reactive::papi::CreateMDSnapshotL2(
      _fbb,
      source_ts,
      source__,
      market__,
...
#endif  // FLATBUFFERS_GENERATED_MDSNAPSHOTL2_REACTIVE_PAPI_H_
