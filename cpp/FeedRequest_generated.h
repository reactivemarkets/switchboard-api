...
#ifndef FLATBUFFERS_GENERATED_FEEDREQUEST_REACTIVE_PAPI_H_
#define FLATBUFFERS_GENERATED_FEEDREQUEST_REACTIVE_PAPI_H_
...
struct FeedRequest FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  reactive::papi::SubReqType sub_req_type() const {
    return static_cast<reactive::papi::SubReqType>(GetField<int8_t>(VT_SUB_REQ_TYPE, 1));
  }
  reactive::papi::FeedType feed_type() const {
    return static_cast<reactive::papi::FeedType>(GetField<int16_t>(VT_FEED_TYPE, 0));
  }
...
struct FeedRequestBuilder {
  ...
  void add_sub_req_type(reactive::papi::SubReqType sub_req_type) {
    fbb_.AddElement<int8_t>(FeedRequest::VT_SUB_REQ_TYPE, static_cast<int8_t>(sub_req_type), 1);
  }
  void add_feed_type(reactive::papi::FeedType feed_type) {
...
inline flatbuffers::Offset<FeedRequest> CreateFeedRequest(
    ...
    reactive::papi::SubReqType sub_req_type = reactive::papi::SubReqType::Subscribe,
    reactive::papi::FeedType feed_type = reactive::papi::FeedType::Default,
    uint16_t grouping = 0,
    int16_t depth = 0,
    int16_t frequency = 0,
...
inline flatbuffers::Offset<FeedRequest> CreateFeedRequestDirect(
  ...
  return reactive::papi::CreateFeedRequest(
      _fbb,
      req_id__,
      sub_req_type,
      feed_type,
...
#endif  // FLATBUFFERS_GENERATED_FEEDREQUEST_REACTIVE_PAPI_H_
