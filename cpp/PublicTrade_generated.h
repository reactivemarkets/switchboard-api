...
#ifndef FLATBUFFERS_GENERATED_PUBLICTRADE_COM_REACTIVEMARKETS_PAPI_H_
#define FLATBUFFERS_GENERATED_PUBLICTRADE_COM_REACTIVEMARKETS_PAPI_H_
...
struct PublicTrade FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  com::reactivemarkets::papi::Side side() const {
    return static_cast<com::reactivemarkets::papi::Side>(GetField<int16_t>(VT_SIDE, 0));
  }
  double qty() const {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int16_t>(verifier, VT_SIDE) &&
...
struct PublicTradeBuilder {
  ...
  void add_side(com::reactivemarkets::papi::Side side) {
    fbb_.AddElement<int16_t>(PublicTrade::VT_SIDE, static_cast<int16_t>(side), 0);
  }
...
inline flatbuffers::Offset<PublicTrade> CreatePublicTrade(
    ...
    uint16_t flags = 0,
    com::reactivemarkets::papi::Side side = com::reactivemarkets::papi::Side_None,
    double qty = 0.0,
    double price = 0.0,
...
inline flatbuffers::Offset<PublicTrade> CreatePublicTradeDirect(
  ...
  return com::reactivemarkets::papi::CreatePublicTrade(
      _fbb,
      source_ts,
      source__,
      market__,
...
#endif  // FLATBUFFERS_GENERATED_PUBLICTRADE_COM_REACTIVEMARKETS_PAPI_H_
