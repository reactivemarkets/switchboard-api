...
static create(builder:flatbuffers.Builder, sourceTs:flatbuffers.Long, sourceOffset:flatbuffers.Offset, marketOffset:flatbuffers.Offset, feedId:number, orderIdOffset:flatbuffers.Offset, flags:number, side:NS17503805021538163740.PlatformApi.Side, qty:number, price:number):flatbuffers.Offset {
